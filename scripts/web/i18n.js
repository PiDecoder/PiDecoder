...
(function(global){
  ...
  const STRINGS={
    fr:{
      ...
      'ssh.title':'Accès SSH',
      'ssh.hint':'Active l\'accès SSH pour te connecter à distance en ligne de commande (dépannage, mise à jour manuelle). Désactivé par défaut sur l\'image PiDecoder.',
      'ssh.status_active':'SSH actif',
      'ssh.status_inactive':'SSH inactif',
      'ssh.unsupported':'Impossible de déterminer l\'état de SSH sur ce système.',
      'ssh.enable_button':'Activer SSH',
      'ssh.disable_button':'Désactiver SSH',
      'ssh.enabled_toast':'SSH activé.',
      'ssh.disabled_toast':'SSH désactivé.',
      'ssh.password_warning_default':'⚠️ Aucun changement de mot de passe SSH n\'a été fait depuis cette interface. S\'il n\'a pas été changé autrement, c\'est probablement encore celui par défaut de l\'image — à changer avant d\'activer SSH sur un réseau qui n\'est pas de confiance.',
      'ssh.password_title':'Mot de passe SSH',
      'ssh.password_hint':'Change le mot de passe du compte Linux utilisé pour se connecter en SSH (le même que la session graphique). Le mot de passe demandé ci-dessous est ton mot de passe administrateur Web actuel — pas le mot de passe SSH — il sert seulement à confirmer que c\'est bien toi.',
      'ssh.password_default_info':'Utilisateur SSH sur cet appareil : {username}. Mot de passe par défaut : sur une carte flashée avec l\'image PiDecoder, c\'est « pidecoder » (sauf s\'il a été personnalisé avec --user-password au moment de fabriquer l\'image) ; sur une installation manuelle de Raspberry Pi OS, c\'est celui choisi à l\'installation du système.',
      'ssh.username_unknown':'compte inconnu',
      'ssh.password_web_current_label':'Mot de passe administrateur Web actuel',
      'ssh.password_new_label':'Nouveau mot de passe SSH',
      'ssh.password_confirm_label':'Confirmer le nouveau mot de passe SSH',
      'ssh.password_apply_button':'Changer le mot de passe SSH',
      'ssh.password_changed_toast':'✔ Mot de passe SSH modifié',
    ...
    en:{
      ...
      'ssh.hint':'Turn on SSH to connect remotely over the command line (troubleshooting, manual updates). Disabled by default on the PiDecoder image.',
      'ssh.status_active':'SSH active',
      'ssh.status_inactive':'SSH inactive',
      'ssh.unsupported':'Unable to determine the SSH status on this system.',
      'ssh.enable_button':'Enable SSH',
      'ssh.disable_button':'Disable SSH',
      'ssh.enabled_toast':'SSH enabled.',
      'ssh.disabled_toast':'SSH disabled.',
      'ssh.password_warning_default':'⚠️ No SSH password change has been made from this interface. If it hasn\'t been changed some other way, it\'s probably still the image\'s default — change it before enabling SSH on an untrusted network.',
      'ssh.password_title':'SSH password',
      'ssh.password_hint':'Changes the password of the Linux account used to connect over SSH (the same one as the graphical session). The password requested below is your current Web admin password — not the SSH password — it\'s only used to confirm it\'s really you.',
      'ssh.password_default_info':'SSH username on this device: {username}. Default password: on a card flashed from the PiDecoder image, it\'s "pidecoder" (unless customized with --user-password when the image was built); on a manual Raspberry Pi OS install, it\'s whichever password was chosen during setup.',
      'ssh.username_unknown':'unknown account',
      'ssh.password_web_current_label':'Current Web admin password',
      'ssh.password_new_label':'New SSH password',
      'ssh.password_confirm_label':'Confirm new SSH password',
      'ssh.password_apply_button':'Change SSH password',
      'ssh.password_changed_toast':'✔ SSH password changed',
