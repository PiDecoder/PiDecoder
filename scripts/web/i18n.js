...
(function(global){
  ...
  const STRINGS={
    fr:{
      ...
      'network.change_scheduled':'Changement appliqué — confirme dans les {seconds}s ci-dessous, sinon il sera automatiquement annulé.',
      ...
      'network.pending_hint':'Si tu peux toujours accéder à cette page, clique sur Confirmer. Sans confirmation d\'ici {seconds}s, l\'ancien réglage sera automatiquement rétabli.',
    ...
    en:{
      ...
      'network.change_scheduled':'Change applied — confirm within {seconds}s below, otherwise it will be automatically reverted.',
      ...
      'network.pending_hint':'If you can still reach this page, click Confirm. Without confirmation within {seconds}s, the previous setting will be automatically restored.',
