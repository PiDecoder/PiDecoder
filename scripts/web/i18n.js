...
(function(global){
  ...
  const STRINGS={
    fr:{
      ...
      'network.pending_hint':'Le changement s\'applique en quelques secondes. Si tu peux toujours accéder à cette page une fois appliqué, clique sur Confirmer. Sans confirmation d\'ici {seconds}s, l\'ancien réglage sera automatiquement rétabli.',
    ...
    en:{
      ...
      'network.pending_hint':'The change takes effect within a few seconds. If you can still reach this page once applied, click Confirm. Without confirmation within {seconds}s, the previous setting will be automatically restored.',
