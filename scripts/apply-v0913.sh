...
BACKUP="${TARGET}.backup-v0.9.1.2-${STAMP}"
...
echo
echo "PiDecoder v0.9.1.3 Media Profiles Fix installé."
echo "Log SOAP : /tmp/pidecoder-onvif.log"
echo "Backup   : $BACKUP"
